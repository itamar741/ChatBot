    ...
    return (
        <form onSubmit={onSubmit} className="p-4 bg-white">
            <div className="flex items-center bg-[#F9F9F5] rounded-full p-3 shadow-md border border-gray-200">
                ...
                <button
                    type="submit"
                    className="bg-gradient-to-r from-[#7ef0b7] to-[#d2e896] hover:from-[#7ef0b7]/70 hover:to-[#d2e896]/70 rounded-full p-3 ml-2 shadow-md transition-all duration-200 group"
                >
